...
public class DI_ProcessoInterno extends Node{
	
	public DI_ProcessoInterno(int posx, int posy, int largura, int altura, SVG SVGPath) {
		super(posx, posy, largura, altura, SVGPath);
		texto = new TextBox(posx, posy,largura/2,10, "");
		this.background = new Cor(0,0,0);
	...
	public Node clone() {
		...
		DI_ProcessoInterno node = new DI_ProcessoInterno(this.getX(), this.getY(), this.getLargura(), this.getAltura(), this.svg);
