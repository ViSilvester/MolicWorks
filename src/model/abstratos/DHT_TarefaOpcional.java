...
public class DHT_TarefaOpcional extends Node {
	
	int executabilidade;

	public DHT_TarefaOpcional(int posx, int posy, int largura, int altura, SVG SVGPath) {
	...
	public Node clone() {
		...
		DHT_TarefaOpcional node = new DHT_TarefaOpcional(this.getX(), this.getY(), this.getLargura(), this.getAltura(), this.svg);
	...
	public int getExecutabilidade() {
		return executabilidade;
	}
